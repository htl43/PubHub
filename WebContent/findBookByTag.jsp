...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<h1>PUBHUB <small>Find Book By Tag</small></h1>
		<hr class="book-primary">

				
		<form action="FindBookByTag" method="post" class="form-horizontal">
		  <div class="form-group">
		    <label for="isbn13" class="col-sm-4 control-label">Searching Tag</label>
		    <div class="col-sm-5">
