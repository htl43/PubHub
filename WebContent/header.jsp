...
<html>
<head>http://marketplace.eclipse.org/marketplace-client-intro?mpc_install=38258
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Tag Publishing<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                          <li><a href="TagPublished">All Tags</a></li>
                          <li class="divider"></li>
                          <li><a href="PublishTag">Publish Tag</a></li>
                          <li class="divider"></li>
                          <li><a href="FindBookByTag">Find Book</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
